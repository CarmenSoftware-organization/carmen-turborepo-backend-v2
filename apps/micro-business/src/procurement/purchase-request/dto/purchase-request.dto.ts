import { z } from 'zod';
import { EmbeddedDepartmentSchema, EmbeddedWorkflowSchema } from '@/common/dto/embedded.dto';
import { ProductCreate } from '@/master/products/dto/product.dto';
...
export const PurchaseRequestDetailSchema = CreatePurchaseRequestDetailSchema;
export const PurchaseRequestSchema = CreatePurchaseRequestSchema;

// Validation schema for PR before submit
export const ValidatePRBeforeSubmitSchema = z.object({
  id: z.string().uuid(),
  pr_no: z.string(),
  pr_date: z.date().or(z.string()),
  pr_status: z.string(),
