...
export type CreateStoreRequisitionComment = z.infer<typeof CreateStoreRequisitionCommentSchema>;
...
export type UpdateStoreRequisitionComment = z.infer<typeof UpdateStoreRequisitionCommentSchema>;

export class UpdateStoreRequisitionCommentDto extends createZodDto(UpdateStoreRequisitionCommentSchema) {}

export interface StoreRequisitionCommentResponse {
  id: string;
