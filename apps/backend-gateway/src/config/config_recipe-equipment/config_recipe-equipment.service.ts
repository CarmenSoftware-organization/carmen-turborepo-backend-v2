...
export class Config_RecipeEquipmentService {
  ...
  async create(createDto: ICreateRecipeEquipment, user_id: string, bu_code: string, version: string): Promise<Result<any>> {
  ...
  async update(updateDto: IUpdateRecipeEquipment, user_id: string, bu_code: string, version: string): Promise<Result<any>> {
  ...
  async patch(updateDto: IUpdateRecipeEquipment, user_id: string, bu_code: string, version: string): Promise<Result<any>> {
