...
export class Config_RecipeCuisineService {
  ...
  async create(createDto: ICreateRecipeCuisine, user_id: string, bu_code: string, version: string): Promise<Result<any>> {
  ...
  async update(updateDto: IUpdateRecipeCuisine, user_id: string, bu_code: string, version: string): Promise<Result<any>> {
  ...
  async patch(updateDto: IUpdateRecipeCuisine, user_id: string, bu_code: string, version: string): Promise<Result<any>> {
