...
import { ICreateMenu, IUpdateMenu } from './dto/menu.dto';

@Injectable()
export class Config_MenuService {
  private readonly logger: BackendLogger = new BackendLogger(
    Config_MenuService.name,
  );
