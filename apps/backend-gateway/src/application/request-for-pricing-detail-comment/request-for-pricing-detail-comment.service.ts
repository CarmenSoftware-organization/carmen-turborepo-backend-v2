...
@Injectable()
export class RequestForPricingDetailCommentService {
  private readonly logger: BackendLogger = new BackendLogger(
    RequestForPricingDetailCommentService.name,
  );
  ...
  async findById(
    ...
    const res: Observable<MicroserviceResponse> = this.businessService.send(
      { cmd: 'request-for-pricing-detail-comment.find-by-id', service: 'request-for-pricing-detail-comment' },
  ...
  async findAllByRequestForPricingDetailId(
    ...
    const res: Observable<MicroserviceResponse> = this.businessService.send(
      { cmd: 'request-for-pricing-detail-comment.find-all-by-request-for-pricing-detail-id', service: 'request-for-pricing-detail-comment' },
      { request_for_pricing_detail_id, user_id, bu_code, paginate, version, ...getGatewayRequestContext() },
    );
    const response = await firstValueFrom(res);
    if (response.response.status !== HttpStatus.OK) {
      return Result.error(
  ...
  async create(
    ...
    const res: Observable<MicroserviceResponse> = this.businessService.send(
      { cmd: 'request-for-pricing-detail-comment.create', service: 'request-for-pricing-detail-comment' },
  ...
  async update(
    ...
    const res: Observable<MicroserviceResponse> = this.businessService.send(
      { cmd: 'request-for-pricing-detail-comment.update', service: 'request-for-pricing-detail-comment' },
  ...
  async delete(
    ...
    const res: Observable<MicroserviceResponse> = this.businessService.send(
      { cmd: 'request-for-pricing-detail-comment.delete', service: 'request-for-pricing-detail-comment' },
      { id, user_id, bu_code, version, ...getGatewayRequestContext() },
    );
    const response = await firstValueFrom(res);
    if (response.response.status !== HttpStatus.OK) {
  ...
  async addAttachment(
    ...
    const res: Observable<MicroserviceResponse> = this.businessService.send(
      { cmd: 'request-for-pricing-detail-comment.add-attachment', service: 'request-for-pricing-detail-comment' },
  ...
  async removeAttachment(
    ...
    const res: Observable<MicroserviceResponse> = this.businessService.send(
      { cmd: 'request-for-pricing-detail-comment.remove-attachment', service: 'request-for-pricing-detail-comment' },
        ...
        this.logger.warn(
          {
            ...
            bu_code,
            request_for_pricing_detail_id: dto.request_for_pricing_detail_id,
