...
export class UnitCommentController {
  ...
  @ApiOperation({ summary: 'Get all comments for a unit', operationId: 'findAllUnitComments', tags: ['Master', 'Unit Comment'], responses: { 200: { description: 'Comments retrieved successfully' } } } as any)
  @HttpCode(HttpStatus.OK)
  async findAllByUnitId(@Param('bu_code') bu_code: string, @Param('unit_id') unit_id: string, @Req() req: Request, @Query() query: IPaginateQuery, @Query('version') version: string = 'latest'): Promise<unknown> {
  ...
  @ApiVersionMinRequest()
  @ApiOperation({ summary: 'Get a unit comment by ID', operationId: 'findOneUnitComment', tags: ['Master', 'Unit Comment'], responses: { 200: { description: 'Comment retrieved successfully' } } } as any)
  @HttpCode(HttpStatus.OK)
  ...
  @ApiVersionMinRequest()
  @ApiOperation({ summary: 'Create a new unit comment', operationId: 'createUnitComment', tags: ['Master', 'Unit Comment'], responses: { 201: { description: 'Comment created successfully' } } } as any)
  ...
  @ApiVersionMinRequest()
  @ApiOperation({ summary: 'Update a unit comment', operationId: 'updateUnitComment', tags: ['Master', 'Unit Comment'], responses: { 200: { description: 'Comment updated successfully' } } } as any)
  @ApiBody({ type: UpdateUnitCommentDto })
  @HttpCode(HttpStatus.OK)
  async update(@Param('bu_code') bu_code: string, @Param('id') id: string, @Body() updateDto: UpdateUnitCommentDto, @Req() req: Request, @Query('version') version: string = 'latest'): Promise<unknown> {
    const { user_id } = ExtractRequestHeader(req);
  ...
  @ApiVersionMinRequest()
  @ApiOperation({ summary: 'Delete a unit comment', operationId: 'deleteUnitComment', tags: ['Master', 'Unit Comment'], responses: { 200: { description: 'Comment deleted successfully' } } } as any)
  @HttpCode(HttpStatus.OK)
  ...
  @ApiVersionMinRequest()
  @ApiOperation({ summary: 'Add attachment to a unit comment', operationId: 'addAttachmentToUnitComment', tags: ['Master', 'Unit Comment'], responses: { 200: { description: 'Attachment added successfully' } } } as any)
  ...
  @ApiVersionMinRequest()
  @ApiOperation({ summary: 'Remove attachment from a unit comment', operationId: 'removeAttachmentFromUnitComment', tags: ['Master', 'Unit Comment'], responses: { 200: { description: 'Attachment removed successfully' } } } as any)
  @HttpCode(HttpStatus.OK)
