...
-- AddForeignKey
ALTER TABLE "tb_stock_in_detail" ADD CONSTRAINT "tb_stock_in_detail_tb_locationId_fkey" FOREIGN KEY ("tb_locationId") REFERENCES "tb_location"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "tb_stock_out_detail" ADD CONSTRAINT "tb_stock_out_detail_tb_locationId_fkey" FOREIGN KEY ("tb_locationId") REFERENCES "tb_location"("id") ON DELETE SET NULL ON UPDATE CASCADE;
